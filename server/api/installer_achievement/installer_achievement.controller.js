...
var Achievements = require('./installer_achievement.model');
...
exports.show = function (req, res) {
    Achievements.findByIdAsync(req.params.id)
...
exports.getByInstaller = function(req, res){
    Achievements.findAsync({InstallerNumber:req.params.id})
        .then(handleEntityNotFound(res))
        .then(responseWithResult(res))
        .catch(handleError(res));
}
...
exports.create = function (req, res) {
    ...
    Achievements.createAsync(req.body)
