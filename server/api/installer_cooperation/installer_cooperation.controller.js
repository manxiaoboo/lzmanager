...
var Cooperations = require('./installer_cooperation.model');
...
exports.show = function (req, res) {
    Cooperations.findByIdAsync(req.params.id)
...
exports.getByInstaller = function(req, res){
    Cooperations.findAsync({InstallerNumber:req.params.id})
        .then(handleEntityNotFound(res))
        .then(responseWithResult(res))
        .catch(handleError(res));
}
...
exports.create = function (req, res) {
    ...
    Cooperations.createAsync(req.body)
