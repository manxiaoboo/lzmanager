...
var Installer_Personnelconfigurations = require('./installer_personnelconfiguration.model');
...
exports.index = function (req, res) {
    Installer_Personnelconfigurations.findAsync()
...
exports.show = function (req, res) {
    Installer_Personnelconfigurations.findByIdAsync(req.params.id)
        .then(handleEntityNotFound(res))
        .then(responseWithResult(res))
        .catch(handleError(res));
};

exports.getByInstallerId = function(req, res){
    Installer_Personnelconfigurations.findAsync({InstallerNumber:req.params.id})
        .then(handleEntityNotFound(res))
        .then(responseWithResult(res))
        .catch(handleError(res));
}
...
exports.create = function (req, res) {
    ...
    Installer_Personnelconfigurations.createAsync(req.body)
