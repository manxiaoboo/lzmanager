...
var Installer_Businesscontacts = require('./installer_businesscontact.model');
...
exports.index = function (req, res) {
    Installer_Businesscontacts.findAsync()
...
exports.show = function (req, res) {
    Installer_Businesscontacts.findByIdAsync(req.params.id)
...
exports.getByInstallerId = function(req, res){
    Installer_Businesscontacts.findAsync({InstallerNumber:req.params.id})
        .then(handleEntityNotFound(res))
        .then(responseWithResult(res))
        .catch(handleError(res));
}
...
exports.create = function (req, res) {
    ...
    req.body.ContactRegistrationDate = new Date();
    Installer_Businesscontacts.createAsync(req.body)
