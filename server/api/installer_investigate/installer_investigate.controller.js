...
var Investigates = require('./installer_investigate.model');
...
exports.show = function (req, res) {
    Investigates.findByIdAsync(req.params.id)
...
exports.getByInstaller = function(req, res){
    Investigates.findAsync({InstallerNumber:req.params.id})
        .then(handleEntityNotFound(res))
        .then(responseWithResult(res))
        .catch(handleError(res));
}
...
exports.create = function (req, res) {
    ...
    Investigates.createAsync(req.body)
